...
""" + (f'''
  <p class="hint"><span>The Spamhaus lookup runs against a personal query
  allowance, so it is rationed. Usually nothing happens; occasionally a checkbox
  appears below asking you to confirm you are a person, and the other lists are
  checked either way.</span></p>
